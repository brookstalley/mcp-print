...
T = TypeVar("T", bound="ConfirmOrderResponse200Links")


@_attrs_define
class ConfirmOrderResponse200Links:
    """HATEOAS links
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        confirm_order_response_200_links.additional_properties = d
        return confirm_order_response_200_links
