...
T = TypeVar("T", bound="GetWarehouseProductsResponse200Links")


@_attrs_define
class GetWarehouseProductsResponse200Links:
    """HATEOAS links
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_warehouse_products_response_200_links = cls(
            self_=self_,
            next_=next_,
            previous=previous,
            first=first,
        ...
        get_warehouse_products_response_200_links.additional_properties = d
        return get_warehouse_products_response_200_links
