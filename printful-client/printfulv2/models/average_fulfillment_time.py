...
T = TypeVar("T", bound="AverageFulfillmentTime")


@_attrs_define
class AverageFulfillmentTime:
    """Average fulfillment time report

    Attributes:
        value (str): Average time it took Printful to fulfill your orders.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        average_fulfillment_time = cls(
            value=value,
            relative_difference=relative_difference,
        )

        average_fulfillment_time.additional_properties = d
        return average_fulfillment_time
