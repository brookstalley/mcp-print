...
T = TypeVar("T", bound="GetOrderEstimationTaskResponse200Data")


@_attrs_define
class GetOrderEstimationTaskResponse200Data:
    """
    Attributes:
        id (str): Task ID Example: fc959efb-b3a0-4c12-9cc6-f54d3158291d.
        status (OrderEstimationTaskSummaryStatus): Task status Example: completed.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_order_estimation_task_response_200_data = cls(
            id=id,
            status=status,
            costs=costs,
            retail_costs=retail_costs,
        ...
        get_order_estimation_task_response_200_data.additional_properties = d
        return get_order_estimation_task_response_200_data
