...
T = TypeVar("T", bound="GetMockupTemplatesByProductIdResponse200Links")


@_attrs_define
class GetMockupTemplatesByProductIdResponse200Links:
    """HATEOAS links
    ...
    Attributes:
        ...
        product (Union[Unset, HateoasLink]):
    """
    ...
    product: Union[Unset, "HateoasLink"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_product, Unset):
            ...
            product = HateoasLink.from_dict(_product)

        get_mockup_templates_by_product_id_response_200_links = cls(
            self_=self_,
            next_=next_,
            previous=previous,
            first=first,
        ...
        get_mockup_templates_by_product_id_response_200_links.additional_properties = d
        return get_mockup_templates_by_product_id_response_200_links
