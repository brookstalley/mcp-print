...
T = TypeVar("T", bound="GetWarehouseProductsResponse200DataItemLinks")


@_attrs_define
class GetWarehouseProductsResponse200DataItemLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_warehouse_products_response_200_data_item_links = cls(
            self_=self_,
            warehouse_variants=warehouse_variants,
        )

        get_warehouse_products_response_200_data_item_links.additional_properties = d
        return get_warehouse_products_response_200_data_item_links
