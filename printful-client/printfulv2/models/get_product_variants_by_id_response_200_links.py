...
T = TypeVar("T", bound="GetProductVariantsByIdResponse200Links")


@_attrs_define
class GetProductVariantsByIdResponse200Links:
    """HATEOAS links
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_product_variants_by_id_response_200_links = cls(
            self_=self_,
            product_details=product_details,
            next_=next_,
            previous=previous,
        ...
        get_product_variants_by_id_response_200_links.additional_properties = d
        return get_product_variants_by_id_response_200_links
