...
class OrderLinks:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        order_confirmation = self.order_confirmation.to_dict()

        order_invoices = self.order_invoices.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        order_confirmation = HateoasLink.from_dict(d.pop("order_confirmation"))

        order_invoices = HateoasLink.from_dict(d.pop("order_invoices"))
        ...
        order_links.additional_properties = d
        return order_links
