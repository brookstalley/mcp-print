...
T = TypeVar("T", bound="GetCategoriesByProductIdResponse200Links")


@_attrs_define
class GetCategoriesByProductIdResponse200Links:
    """HATEOAS links
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_categories_by_product_id_response_200_links = cls(
            self_=self_,
            all_categories=all_categories,
            next_=next_,
            previous=previous,
        ...
        get_categories_by_product_id_response_200_links.additional_properties = d
        return get_categories_by_product_id_response_200_links
