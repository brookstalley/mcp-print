...
T = TypeVar("T", bound="TotalPaidOrders")


@_attrs_define
class TotalPaidOrders:
    """Total paid orders report

    Attributes:
        value (int): Number of unique orders for period
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        total_paid_orders = cls(
            value=value,
            relative_difference=relative_difference,
        )

        total_paid_orders.additional_properties = d
        return total_paid_orders
