...
if TYPE_CHECKING:
    from ..models.create_order_response_400_error import CreateOrderResponse400Error
...
class CreateOrderResponse400:
    ...
    Attributes:
        ...
        error (Union[Unset, CreateOrderResponse400Error]):
    """

    code: Union[Unset, int] = UNSET
    result: Union[Unset, str] = UNSET
    error: Union[Unset, "CreateOrderResponse400Error"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_error, Unset):
            ...
            error = CreateOrderResponse400Error.from_dict(_error)
