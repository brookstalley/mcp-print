...
if TYPE_CHECKING:
    from ..models.address_readonly import AddressReadonly
    from ..models.catalog_item_summary import CatalogItemSummary
    from ..models.costs import Costs
    from ..models.customization_readonly import CustomizationReadonly
    from ..models.order_links import OrderLinks
...
class Order:
    ...
    Attributes:
        ...
        recipient (AddressReadonly): Information about the address
        ...
        field_links (OrderLinks): HATEOAS links
        customization (Union[Unset, CustomizationReadonly]): The Order's customization values
    """
    ...
    field_links: "OrderLinks"
    customization: Union[Unset, "CustomizationReadonly"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        customization: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.customization, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recipient = AddressReadonly.from_dict(d.pop("recipient"))
        ...
        field_links = OrderLinks.from_dict(d.pop("_links"))

        _customization = d.pop("customization", UNSET)
        customization: Union[Unset, CustomizationReadonly]
        if isinstance(_customization, Unset):
            customization = UNSET
        else:
            customization = CustomizationReadonly.from_dict(_customization)
