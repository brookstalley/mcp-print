...
T = TypeVar("T", bound="GetApprovalSheetsResponse200ApprovalSheetLinks")


@_attrs_define
class GetApprovalSheetsResponse200ApprovalSheetLinks:
    """HATEOAS links
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_approval_sheets_response_200_approval_sheet_links = cls(
            self_=self_,
            next_=next_,
            previous=previous,
            first=first,
        ...
        get_approval_sheets_response_200_approval_sheet_links.additional_properties = d
        return get_approval_sheets_response_200_approval_sheet_links
