...
T = TypeVar("T", bound="GetOrdersResponse200Links")


@_attrs_define
class GetOrdersResponse200Links:
    """HATEOAS links
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_orders_response_200_links = cls(
            self_=self_,
            next_=next_,
            previous=previous,
            first=first,
        ...
        get_orders_response_200_links.additional_properties = d
        return get_orders_response_200_links
